# ddns-IPv6 for ![Windows](https://img.shields.io/badge/-Windows-0078D6?style=flat-square&logo=Windows&logoColor=white)  
...
加入了本地 IPv4 地址检测网站设置配置（注意，需要能获只返回 IPv4 地址的页面）。
--
